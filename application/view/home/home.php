                        ...
                        <div class="col-sm-4 " style="height: 100%; overflow: hidden">
                            <div class="row content_row">
                                <div class="static-content">
                                    <div class="avatar_show_image media">
                                        <div class="media-left">
                                            <a href="#">
                                                <img src="images/albums/avatar_demo.jpg" alt=""
                                                     class=" media-object avatar_modal">
                                            </a>
                                        </div>
                                ...
                                <div class="icon_show_image clearfix">
                                    ...
                                    <a href="javascript:void(0)" class="like-image"><i
                                                class="fa fa-heart fa-lg"></i></a>
                                </div>
                                <div class="comment_show_image" style="max-height: 200px; overflow-y: scroll">
<!--                                    <div class="media">-->
<!--                                        <div class="media-left">-->
<!--                                            <a href="#">-->
...
<!--                                        <textarea name="" id="text-reply-image" class="form-control" rows="1"-->
