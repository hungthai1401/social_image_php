...
//          get like
            ...
            foreach ($id_album as $id) {
                ...
                $getLike = $home->getLikeAlbumsByUserId($userId, $id['album_id']);
...
//            echo json_encode($id_next); EXIT;
            $getImage = $home->getImage($id_next['image_id']);
            $getLikeImage = $home->getLikeImageByUserId($userId, $id_next['image_id']);
            $getImage["like"] = $getLikeImage;
            die(json_encode($getImage));
//            echo $id_next['image_id'];
//            die(json_encode($id_next));
        }else {
            echo "chưa gửi đươc";
        }
    }
    public function imageBack () {
        ...
        if (isset($_POST['action']) == "back_image") {
            ...
            $getLikeImage = $home->getLikeImageByUserId($userId, $id_back['image_id']);
            $getImage["like"] = $getLikeImage;
            die(json_encode($getImage));
        }
    }
