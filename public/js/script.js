...
// load image
    function loadImage(data) {
        ...
        $("#myModal").on('hidden.bs.modal', function (e) {
            ...
            $(".text-cm-reply-img .show").removeClass('show');
...
// show image
    ...
    // Hàm này để trả lời comment image
